...
import { BackgroundEffects, SectionTitle, GlassButton } from "./index";
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 py-20">
        <div className="max-w-6xl w-full">
          ...
          >
            ...
            >
              Notre équipe d'experts est à votre disposition pour vous accompagner dans tous vos projets d'assurance
            </motion.p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="professionnel">Assurance Professionnelle</option>
            ...
            >
              ...
              >
                <h4 className="text-xl font-bold mb-4 text-white">Besoin d'une réponse immédiate ?</h4>
                <p className="text-gray-400 mb-6">Appelez-nous directement pour un conseil personnalisé</p>
